...
#define I_EXP_SHARE_FLAG        0x54           // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
...
#define VAR_LAST_REPEL_LURE_USED    0x55       // If this var has been assigned, last Repel/Lure used will be saved and the player will get prompted with the vanilla repel YES/NO option, unless I_REPEL_LURE_MENU is set to TRUE.
...
#define I_FISHING_MINIGAME          GEN_6 // Each generation uses a variation of reeling in Pokémon once they have been hooked.
